...
class Entity:
  def __init__(self):
    self.api_url_for_get = 'https://rest.entitysport.com/basketball/'
...
class Entity_basketball(Entity) :
  ...
  def get_competition_standings(self, cid,args={}):
    path = 'competition/'+str(cid)+'/standings'
...
and than class Entity_basketball()
        entity = Entity_basketball()
